...
public class Game extends Frame
    ...
    public static final String VERSION_TEXT = "version: 0.0.2";
    ...
    private void init() {
        ...
        if (loader.settings.fullscreen && myDevice.isFullScreenSupported()) {
            ...
            setResizable(true);
            setSize(PREFER_GAME_WIDTH, PREFER_GAME_HEIGHT);
            setLocation((width - PREFER_GAME_WIDTH) >> 1, (height - PREFER_GAME_HEIGHT) >> 1);
        }
        setFocusable(true);
        setVisible(true);
        //
